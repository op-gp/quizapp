      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <nav className="w-full md:w-64 border-b md:border-b-0 md:border-r border-slate-900 bg-slate-900/10 p-4 flex flex-row md:flex-col gap-2 overflow-x-auto md:overflow-x-visible shrink-0 scrollbar-none">
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap shrink-0 md:w-full ${activeTab === 'overview'
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap shrink-0 md:w-full ${activeTab === 'category'
                ? 'bg-indigo-500/10 text-indigo-400 border border-indigo-500/20'
                : 'text-slate-400 hover:text-white hover:bg-slate-900/50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap shrink-0 md:w-full ${activeTab === 'quiz'
                ? 'bg-indigo-500/10 text-indigo-400 border border-indigo-500/20'
                : 'text-slate-400 hover:text-white hover:bg-slate-900/50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap shrink-0 md:w-full ${activeTab === 'question'
                ? 'bg-indigo-500/10 text-indigo-400 border border-indigo-500/20'
                : 'text-slate-400 hover:text-white hover:bg-slate-900/50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap shrink-0 md:w-full ${activeTab === 'students'
                ? 'bg-indigo-500/10 text-indigo-400 border border-indigo-500/20'
                : 'text-slate-400 hover:text-white hover:bg-slate-900/50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap shrink-0 md:w-full ${activeTab === 'admins_list'
                ? 'bg-indigo-500/10 text-indigo-400 border border-indigo-500/20'
                : 'text-slate-400 hover:text-white hover:bg-slate-900/50'
              }`}
          >
        ...
        <main className="flex-1 p-6 relative overflow-y-auto">
          ...
          {feedback && (
            <Alert
              className={`mb-6 max-w-2xl border ${feedback.type === 'success'
                        ...
                        <Card key={q._id} className="border-slate-900 bg-slate-900/10 p-4 space-y-3 relative overflow-hidden">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
                            {q.options.map((o: any, oIdx: number) => (
                              <div
                                key={oIdx}
                                className={`p-2 rounded text-xs border ${o.isCorrect
                    ...
                    <tbody className="divide-y divide-slate-900">
                      {users.filter(u => u.role === 'Student').map((u) => (
                        <tr key={u._id} className="hover:bg-slate-900/30 transition-all text-slate-300">
                          ...
                          <td className="p-4">
                            <span className={`px-2 py-0.5 rounded text-xs font-semibold ${u.isVerified
